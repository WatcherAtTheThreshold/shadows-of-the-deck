...
// ========== SIMPLIFIED HAND SYSTEM ==========
// Main hand rendering function - MUCH SIMPLER
export function renderHand(playerHand, onPlayCard) {
  ...
  // Always rebuild hand completely - simpler and more reliable
  ...
  playerHand.forEach((card, index) => {
    ...
    currentHandCards.push({ element: el, name: card, played: false });
  });
